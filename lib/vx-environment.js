...
module.exports = class vxEnvironment {
   ...
   * @param {*} lambdaEvent
   */
  constructor(log, rootPath, lambdaEvent = null) {
    this.log = log;
  ...
  sync() {
    ...
    let objConfigs = new rConfigs(this.log, this.rootPath, this.env.vxInfoApp);
    ...
    !this.env.vxPathsAppRoot ? (this.env.vxPathsAppRoot = this.rootPath) : false;
