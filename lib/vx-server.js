  ...
  async init() {
    ...
    switch (this.mode) {
      case 'lambda': {
        ...
        // convert body:
        // let oLambdaBody = new rLambdaBody(this.log, this.configs);
        // oLambdaBody.convert(this.lambdaEvent);
        ...
        await this.definitions.routes.create(rExpressApp);
        // init must wait until everything is processed:
